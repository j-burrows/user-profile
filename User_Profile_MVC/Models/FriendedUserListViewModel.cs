...
namespace User_Profile.Models{
    public class FriendedUserListViewModel : UserListViewModel{
        new public static UsersBlockedListView ForUserPage(string username, int Page_ID){
            ...
            var profiles = service.Profile_GetUserWhoHaveFriended(username);
